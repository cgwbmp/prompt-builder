...
export function OutputPanel({ output, custom, onCustomChange, selectedCount, onClear, onCopied }: OutputPanelProps) {
  ...
  return (
    <aside id="output-panel" className="glass-dark flex flex-col gap-4 rounded-2xl !border-t-2 !border-t-neon-cyan/70 p-4 lg:sticky lg:top-6 lg:h-[calc(100vh-3rem)]">
